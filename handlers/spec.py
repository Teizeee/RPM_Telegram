...
async def speciality_kb(call: CallbackQuery, state: FSMContext):
    ...
    if call.data=="Арх":
        spec="Архитектор"
        await call.message.answer(text="Архитектор — это специалист, который участвует в проектировании и строительстве различных объектов — зданий, сооружений и территорий. "
        ...
        spec="Гидрогеолог"
        await call.message.answer(text="Гидрогеолог - это специалист, изучающий подземные воды, их происхождение, движение, "
        ...
        spec="Программист"
        await call.message.edit_reply_markup(reply_markup=None)
        await call.message.answer(text="Программист - это специалист, занимающийся разработкой и созданием компьютерных программ и программного обеспечения. "
        ...
        spec="Строитель"
        await call.message.answer(text="Строитель - это специалист, занимающийся возведением зданий, сооружений и других строительных объектов. Профессия строителя включает в себя следующие основные направления деятельности:\n"
